...
Java_gisia_martin_com_perceptron_MainActivity_convolucionModel(JNIEnv *env, jobject instance) {
    ...
    uint32_t dimsInput[4] = {9,3,3,1}; //batches, height, width, depth_in
    ...
    uint32_t dimsOutput[4] = {9,2,2,1}; //batches, out_height, out_width, depth_out
    ...
    float inputValues[9] = {23,34,32,23,43,43,23,12,12};
